...
namespace backend.DataAccess.Migrations
{
    ...
    [Migration("20210511131327_sprints3")]
            ...
            modelBuilder.Entity("backend.Domain.Sprint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ActualLength = 6,
                            DefaultLength = 5,
                            EndDate = new DateTime(2021, 5, 17, 0, 0, 0, 0, DateTimeKind.Local),
                            StartDate = new DateTime(2021, 5, 11, 0, 0, 0, 0, DateTimeKind.Local),
                            TeamId = 1,
                            Title = "First sprint"
                        },
                        new
                        {
                            ...
                            ActualLength = 3,
                            DefaultLength = 3,
                            EndDate = new DateTime(2021, 5, 14, 0, 0, 0, 0, DateTimeKind.Local),
                            StartDate = new DateTime(2021, 5, 11, 0, 0, 0, 0, DateTimeKind.Local),
                            TeamId = 1,
                            Title = "Second sprint"
                        });
            ...
            modelBuilder.Entity("backend.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a376816a-1a59-4f2a-b13b-267839e4fd52",
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "64f93282-7eaf-4125-8e9d-9521f7bcd4cd",
                            EmailConfirmed = false,
                            FirstName = "Paulius",
                            LockoutEnabled = false,
                            PhoneNumberConfirmed = false,
